...
<body>
    ...
    <section class="bg-warning p-1">
        <div class="container">
            <div class="row">
                <h2 class="text-warning"><i class="fa fa-users"></i> Customers</h2>
            </div>
        </div>
    </section>
    ...
    <div class="container">
        <div class="card mt-5">
            <div class="card-header bg-info text-warning">
                <h3><i class="fa fa-users"></i> Customers List</h3>
            </div>
            <div class="card-body bg-light">
                <table class="table table-hover table-striped text-center table-responsive-sm table-responsive-md">
